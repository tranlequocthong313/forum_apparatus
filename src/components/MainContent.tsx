      ...
      <Grid item mobile={12} laptop={10}>
        ...
        <Card sx={{ mb: 3 }}>
          <CardContent>
            ...
            <Typography variant="body2">This is a featured post with some content...</Typography>
          </CardContent>
        </Card>
        <List>
          {[1, 2, 3, 4, 5].map((item) => (
            <React.Fragment key={item}>
              <ListItem alignItems="flex-start">
                <ListItemText primary={`Recent Post ${item}`} secondary="This is a short description of the post..." />
              </ListItem>
